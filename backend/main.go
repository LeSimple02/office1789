...
func main() {
	...
	// OnlyOffice envoie aussi un GET sur callbackUrl pour vérifier l'accessibilité.
	// On renvoie un 200 simple pour éviter les warnings "document could not be saved".
	r.GET("/api/onlyoffice/callback", func(c *gin.Context) {
