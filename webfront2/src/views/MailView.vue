      ...
      <aside class="sidebar">
        ...
        <div class="sidebar-list">
          <div
            v-for="user in users"
            :key="user.id"
            :class="['sidebar-card', selectedDiscussion && selectedDiscussion.id === user.id && !selectedDiscussion.isGroup ? 'active' : '']"
            @click="selectDiscussion(user, false)"
          >
        ...
        <div class="sidebar-list">
          <div
            ...
            :key="group.id"
            :class="['sidebar-card', selectedDiscussion && selectedDiscussion.id === group.id && selectedDiscussion.isGroup ? 'active' : '']"
            @click="selectDiscussion(group, true)"
          >
            <img class="sidebar-avatar" :src="group.avatar" alt="avatar" />
            <span class="sidebar-name">{{ group.name }}</span>
            <button class="btn btn-danger" @click.stop="openDeleteModal(group)">
        ...
        <div v-if="selectedDiscussion" class="messages-modal">
          <div class="conv-header">
            ...
            <div class="conv-actions">
              ...
              <button
                v-if="selectedDiscussion && selectedDiscussion.isGroup"
                class="btn"
                @click="showGroupUsers = true"
              >
                <span class="icon">👥</span>
              </button>
              <div class="dropdown">
            ...
            <div v-if="showGroupUsers" class="modal-overlay">
              <div class="modal">
                ...
                <div class="modal-actions">
                  <button class="btn" @click="showGroupUsers = false">
                    Fermer
                  </button>
                </div>
              </div>
          ...
          <div class="messages-list">
            <div
              ...
              :key="msg.id"
              :class="['message', msg.fromMe ? 'me' : 'other']"
            >
...
function handleAttachment(e) {
  ...
  if (file) {
    ...
    alert('Pièce jointe sélectionnée : ' + file.name)
  }
}
...
/* Modal liste utilisateurs groupe */
.group-users-list {
  list-style: none;
  padding: 0;
  margin: 18px 0;
