...
<template>
  <div class="login-container">
    ...
    <div class="hero-card">
      ...
      <h1>🔐 Connexion Office1789</h1>
      <h2>Accédez à votre espace collaboratif</h2>
    </div>
    ...
    <!-- Info Card -->
    <div class="info-card">
      <p>💡 <strong>Première connexion ?</strong> Créez votre compte gratuitement et profitez de 50 Go de stockage !</p>
    </div>
  </div>
</template>
