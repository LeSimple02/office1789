...
// OFFICE1789: Force load custom plugins BEFORE startup hook
error_log('[OFFICE1789] Force loading plugins...');
...
error_log('[OFFICE1789] Loaded: ' . implode(', ', $RCMAIL->plugins->loaded_plugins()));
